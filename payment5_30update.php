...
<head>
    ...
    if($_POST) {
        ...
        echo 'alert("Details Successfully Updated"); location.href="payment5_30.php"';
        echo '</script>';
    }
    ?>
</head>
...
<div style=" height: 300px; width: 1200px; position: absolute; bottom: 230px; left: 280px">
        ...
        <center style="position: relative; right:80px" >
          ...
          <a href="payment5_30.php" style="width: 100px; height: 50px" class="btn btn-danger" ><b style="position: relative; top: 7px" >CANCEL</b></a>
        </center>
        </form>     
      </div>
