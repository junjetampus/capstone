...
if ($_GET) {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        echo 'alert("The batch and details you inserted is already existed."); location.href="payment15_record7.php"';
        echo '</script>';
    } else {
        ...
        if ($result) {
            echo '<script language="javascript">';
            echo 'alert("Data Successfully Inserted"); location.href="payment15_record7.php"';
            echo '</script>';
        } else {
            echo "Failed";
        }
...
<div style="width: 1374px; height: 659px; position: relative">
  ...
  <!-- background -->
    ...
    <div style="left: 640px; top: 95px; position: absolute; text-align: center; color: #3A6050; font-size: 36px; font-family: sans-serif; font-weight: bold; word-wrap: break-word">15th PAYMENT</div>
  </div>
  ...
  <div class="tables-scroll">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='payment15_record7update.php?id=" . $row['id'] . "'><i class='fas fa-edit'></i></a> </td>";
                          ...
                          <script>
                              function confirmDelete(id) {
                                  if (confirm("If you 'OK' this details will be surely deleted.")) {
                                      ...
                                      window.location.href = "payment15_record7delete.php?id=" + id;
                                  }
                              }
                          </script>
    </div>
  ...
  <button onclick="document.getElementById('id01').style.display='block'"  style="width: 52px; height: 52px; left:79px; top: 151px; position: absolute; background: #3A6050; border-radius: 10px; border: none">
    ...
    <div>
      <form action="payment15_record7.php" method="post">
  ...
  <div style="display: flex; position: relative; top: 617px; left: 705px">
    ...
    <label for="2" style="margin-left: 10px; margin-right: 10px">15</label>
    <a href="">
      <button style="width: 50px; font-size: 15px; background: #3A6050; color: white"><b>></b></button>
    </a>
  </div>
