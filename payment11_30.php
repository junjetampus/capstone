...
if($_GET){
    ...
    if ($checkResult->num_rows > 0) {
        ...
        echo 'alert("The batch and details you inserted already exist."); location.href="payment11_30.php"';
        echo '</script>';
    } else {
        ...
        if($result) {
            echo '<script language="javascript">';
            echo 'alert("Details Successfully Inserted"); location.href="payment11_30.php"';
            echo '</script>';
        } else {
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:900px">
      ...
      <div class="w3-center" style="font-size: 15px"><br>
        ...
        <b><h3 style="font-family: sans-serif; font-weight">ADD to PAYMENT RECORD</h3></b>
      </div>
...
<div style="width: 1374px; height: 659px; position: relative">
  ...
  <!-- background -->
    ...
    <div style="left: 640px; top: 95px; position: absolute; text-align: center; color: #3A6050; font-size: 36px; font-family: sans-serif; font-weight: bold; word-wrap: break-word">11th PAYMENT</div>
  </div>
  ...
  <div class="tables-scroll">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='payment11_30update.php?id=" . $row['id'] . "'><i class='fas fa-edit'></i></a></td>";
            echo "<td>" . $row['code'] . "</td>";
                          ...
                          <script>
                              function confirmDelete(id) {
                                  if (confirm("If you 'OK' this details will be surely deleted.")) {
                                      ...
                                      window.location.href = "payment11_30delete.php?id=" + id;
                                  }
                              }
                          </script>
    </div>
  ...
  <button onclick="document.getElementById('id01').style.display='block'"  style="width: 52px; height: 52px; left:79px; top: 151px; position: absolute; background: #3A6050; border-radius: 10px; border: none">
    ...
    <div>
      <form action="payment11_30.php" method="post">
  ...
  <div style="display: flex; position: relative; top: 617px; left: 705px">
    <a href="payment10_30.php">
      <button style="width: 50px; font-size: 15px; background: #3A6050; color: white"><b><</b></button>
    </a>
    <label for="2" style="margin-left: 10px; margin-right: 10px">11</label>
