...
<head>
    ...
    <title>Update 5th Payment Record</title>
    ...
    if($_POST) {
        ...
        echo 'alert("Details Successfully Updated"); location.href="payment5_record7.php"';
        echo '</script>';
    }
    ?>
</head>
...
<div style="width: 1374px; height: 659px; position: relative">
  ...
  <div style="width: 110px; left: 60px; top: 8px; position: absolute; text-align: center; color: white; font-size: 36px; font-family: Inter; font-weight: 700; word-wrap: break-word">e-PaL</div>
    ...
    <div style="left: 580px; top: 95px; position: absolute; text-align: center; color: #3A6050; font-size: 36px; font-family: sans-serif; font-weight: bold; word-wrap: break-word">Update 5th PAYMENT</div>
  </div>
...
<div style=" height: 300px; width: 900px; position: absolute; bottom: 150px; left: 280px">
        ...
        <center style="position: relative; right:80px" >
          ...
          <a href="payment5_record7.php" style="width: 100px; height: 50px" class="btn btn-danger" ><b style="position: relative; top: 7px" >CANCEL</b></a>
        </center>
        </form>     
      </div>
